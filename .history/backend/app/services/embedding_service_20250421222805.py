...
def main():
    ...
    json_path = Path("path/to/your/file.json")
    embedding_service.process_json_file(json_path)
    
    # Or process an entire folder of JSONs
    json_folder = Path("path/to/your/jsons")
    embedding_service.process_json_folder(json_folder)
    
    # Get embedding for a specific file
    embedding = embedding_service.get_embedding(json_path)
